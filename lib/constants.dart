...
class Constants {
  ...
  // Flight Intelligence stays on shouldShowProServices (iOS/Android).
  static final bool firebaseAvailable =
      (Platform.isIOS || Platform.isAndroid || Platform.isWindows || Platform.isMacOS);
